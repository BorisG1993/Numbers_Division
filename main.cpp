...
int main() {
    ...
    std::string filepath = "/home/borisg/Projects/NumbersDivision/search_no_solution_u.txt";   
    std::ofstream file(filepath, std::ios::app);
    if (!file) std::cerr << "Error opening file: " << filepath << std::endl;
    
    FindNoSolutions::search_for_potential_new_no_solution(file, 299, 300); 
...
//     std::cout << (FindNoSolutions::determine_with_known_ways(partition) == SolutionType::Unknown);
